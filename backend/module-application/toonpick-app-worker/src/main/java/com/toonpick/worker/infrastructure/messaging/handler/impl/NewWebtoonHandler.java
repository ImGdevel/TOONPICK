...
@Slf4j
@Component
public class NewWebtoonHandler extends AbstractWebtoonEventHandler {
    
    private final WebtoonRegistrationService webtoonRegistrationService;

    public NewWebtoonHandler(ObjectMapper objectMapper, 
                            Validator validator,
    ...
    public SQSEventType getSupportedEventType() {
        return SQSEventType.CRAWL_WEBTOON_NEW;
    }
